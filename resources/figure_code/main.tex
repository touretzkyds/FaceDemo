...
%% Draw Layer Blocks
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\node[canvas is zy plane at x=0] (temp) at (-4,0,0) {\includegraphics[width=8cm,height=8cm]{face.png}};
...
\pic[shift={(0,0,0)}] at (scr6-east) {NewBox={name=cr6,zlabel=\begin{turn}{5}7\end{turn},position=0,%
        xlabel={{"512",}},fill=\pConvColor,opacity=\Opacity,bandfill=\pConvColor,%
        height=9.492,width={6.238},depth=9.492}};

% conv5_1,conv5_2,conv5_3
\pic[shift={(2,0,0)}] at (cr6-east) {NewBox={name=cr7,zlabel=\begin{turn}{5}7\end{turn},position=0,%caption=\newline\newline bounding box\newline predictions,%
...
\node[] at (32,5,0) {\Large\textcolor{\pConvColor}{Light Blue: Pointwise Convolution}};
\node[] at (32,4.5,0) {\Large\textcolor{\dConvColor}{Blue: Depthwise Convolution}};
...
\node[] at (-4,-7,0) {\large{224$\times$224$\times$3}};
...
\node[] at (27.5,-3.5,0) {\large\textcolor{\dConvColor}{conv10: [3,3,1]/1 $\times$ 256}};
\node[] at (27.5,-4,0) {\large\textcolor{\dConvColor}{7$\times$7$\times$256}};
\node[] at (27.5,-4.75,0) {\large\textcolor{\pConvColor}{conv11: [1,1,256]/1 $\times$ 512}};
\node[] at (27.5,-5.25,0) {\large\textcolor{\pConvColor}{7$\times$7$\times$512}};

\node[] at (32,-3,0) {\large\textcolor{\pConvColor}{conv12: [1,1,512]/1 $\times$ 25}};
\node[] at (32,-3.5,0) {\large\textcolor{\pConvColor}{7$\times$7$\times$25}};
